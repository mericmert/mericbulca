    ...
    <main className="flex flex-col items-start p-4 space-y-6">
      ...
      <section>
        <p className="leading-relaxed">
          ...
          Science at
          <strong> Sabancı University</strong>, and soon I&apos;ll be pursuing an
      ...
      <section>
        <p className="leading-relaxed">
          Through this blog, I&apos;ll be sharing my <strong>learning journey</strong> — from tackling
          real-world engineering problems to exploring in-depth research. I hope my experiences will
          inspire and inform. If you&apos;re looking for a fellow engineer to connect with,{" "}
