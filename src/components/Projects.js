...
export default function Projects() {
  return (
    <div className='project-container'>
        ...
        <Project go='https://github.com/mericmert/portfolio' filename='portfolio.gif' title='Personal Portfolio Website' content='I made this fully responsive porfolio website using ReactJS for front-side and MongoDB, NodeJS for back-end.'/>    
    </div>
  )
}
