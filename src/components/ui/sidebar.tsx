    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          "h-dvh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
            ? "md:left-auto group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]"
            : "md:right-auto group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]",
          variant === "floating" || variant === "inset"
            ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+theme(spacing.4)+2px)]"
            : "group-data-[collapsible=icon]:w-[--sidebar-width-icon] md:border-r",
          className
        )}
        {...props}
      >
